# Capsule React Native - Ethers v6 Example

This example uses `react-native` v0.73, but can be plugged in to any of the other react native example versions, just add `ethers` to any of the other examples using the following command.
